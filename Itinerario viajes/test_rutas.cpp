...
int main() {
	...
	test_insertar_ruta();
	cout << "OK -- test_insertar_ruta" << endl;

	// Prueba de consultar_ruta
	test_consultar_ruta();
	cout << "OK -- test_consultar_ruta" << endl;
	...
	cout << "OK -- test_consultar_rutas" << endl;

	// Prueba de consultar_rutas_origen
	test_consultar_rutas_origen();
	cout << "OK -- test_consultar_rutas_origen" << endl;

	// Prueba de consultar_rutas_destino
	test_consultar_rutas_destino();
	cout << "OK -- test_consultar_rutas_destino" << endl;

	// Prueba de consultar_rutas_aeropuertos
	test_consultar_rutas_aeropuertos();
	cout << "OK -- test_consultar_rutas_aeropuertos" << endl;

	// Prueba de consultar_mas_barata
	test_consultar_mas_barata();
	cout << "OK -- test_consultar_mas_barata" << endl;

	// Prueba de eliminar_ruta
	test_eliminar_ruta();
	cout << "OK -- test_eliminar_ruta" << endl;

	// Prueba de eliminar_rutas_aeropuerto
	test_eliminar_rutas_aeropuerto();
	cout << "OK -- test_eliminar_rutas_aeropuerto" << endl;

	// Prueba de eliminar_rutas_origen
	test_eliminar_rutas_origen();
	cout << "OK -- test_eliminar_rutas_origen" << endl;

	// Prueba de eliminar_rutas_destino
	test_eliminar_rutas_destino();
	cout << "OK -- test_eliminar_rutas_destino" << endl;

	// Prueba de obtener_rutas
	test_obtener_rutas();
	cout << "OK -- test_obtener_rutas" << endl;

	// Prueba de guardar_rutas
	test_guardar_rutas();
	cout << "OK -- test_guardar_rutas" << endl;

	// Prueba de obtener_itinerario
	test_obtener_itinerario();
	cout << "OK -- test_obtener_itinerario" << endl;
