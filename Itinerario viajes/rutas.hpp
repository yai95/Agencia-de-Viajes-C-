 ...
 * Fecha:27/05/2018
 *****************************************************************************/
#ifndef RUTAS_HPP_INCLUDED
#define RUTAS_HPP_INCLUDED
#include "ruta.hpp"
...
public:
	...
	// ¡¡NO MODIFICAR NADA EN ELLOS! ¡DEBES DEJARLOS TAL Y COMO ESTÁN!
	...
	bool operator==(const Rutas &otro_objeto) {
		...
		while (iguales && ptr1 != NULL && ptr1->ruta == ptr2->ruta) {
			ptr1 = ptr1->sig;
			ptr2 = ptr2->sig;
		}
